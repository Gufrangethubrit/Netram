// Branch component with tilt effect on hover
  ...
  return (
    ...
    <div className="dashboard">
      ...
      <div className="cards-col">
        ...
        >
          ...
          <div className="card-info">
            <div className="card-num" id="n0">23</div>
        ...
        >
          ...
          <div className="card-info">
            <div className="card-num" id="n1">2300</div>
            <div className="card-label">Camps</div>
        ...
        >
          ...
          <div className="card-info">
            <div className="card-num" id="n2">2200</div>
            <div className="card-label">Vilaages</div>
            {/* <div class="card-sub">Across the Country</div> */}
          </div>
        </div>
        <div 
        ...
        >
          ...
          <div className="card-info">
            <div className="card-num" id="n3">1</div>
      ...
      <div className="map-col">
        <div id="map" className="india-map-frame">
          <img src="./assets/india-map/india-map.png" alt="India map showing Netram Eye Foundation outreach regions" />
        </div>
        <div className="map-info-card">
          ...
          <div className="map-info-addr">
            <i className="fa-solid fa-location-dot" /> E-98, Greater Kailash-2<br />
            <i className="fa-solid fa-map-marker-alt" /> New Delhi – 110048<br />
            <i className="fa-solid fa-phone" />+91-92126-46655
          </div>
    ...
    <div className="dashboard dashboard-hidden" aria-hidden="true">
      {/* Cards */}
      <div className="cards-col">
        <div 
          className="stat-card card-purple" 
        ...
        >
          ...
          <div className="card-info">
            <div className="card-num" id="n0">36</div>
            <div className="card-label">States</div>
            <div className="card-sub">Across the Country</div>
          </div>
        </div>
        ...
        >
          ...
          <div className="card-info">
            <div className="card-num" id="n1">10</div>
        ...
        >
          ...
          <div className="card-info">
            <div className="card-num" id="n2">1</div>
        ...
        >
          ...
          <div className="card-info">
            <div className="card-num" id="n3">0</div>
