...
export default function SeemaGuptaProfile() {
  useEffect(() => {
  ...
  return (
    <div>
      <Header />
      <Breadcrum title="Seema Gupta Profile" />
      <div>
        <section
        ...
        >
          <div className="container">
            <div className="text-center mb-5" data-aos="fade-up">
              ...
              <h2 className="section-title mt-3">Seema Gupta</h2>
              ...
              <div className="col-lg-4">
                <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
                  ...
                  <div className="team-info pt-4 text-center">
                    <h5 className="mb-1">Seema Gupta</h5>
                    <span>President</span>
                  </div>
                </div>
              </div>
              <div className="col-lg-8">
                <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
                  <div className="mb-4">
                    ...
                    <p className="mb-4">
                      Seema Gupta serves as the President of Netram Eye
                      Foundation, bringing a deep commitment to humanitarian
                      causes and community welfare. Under her leadership, the
                      foundation has expanded its reach and deepened its impact
                      across diverse social sectors.
                    </p>
                    {/* Key Highlights */}
                    <div className="profile-highlights mt-4">
                      <h5 className="highlight-title mb-3">
                        <i className="bi bi-award-fill me-2" /> Key Leadership
                        &amp; Vision
                      </h5>
                      <div className="row g-3">
                          ...
                          <div className="highlight-item d-flex align-items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="small text-muted mb-0">
                                Driving major organizational decisions with a
                        ...
                        <div className="col-md-6">
                          <div className="highlight-item d-flex align-items-start gap-3">
                            ...
                            <div>
                              <strong>Healthcare Advocacy</strong>
                              <p className="small text-muted mb-0">
                                Championing the cause of accessible eye care and
                        ...
                        <div className="col-md-6">
                          <div className="highlight-item d-flex align-items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="small text-muted mb-0">
                                Overseeing large-scale distribution drives and
                                screening camps in underserved areas.
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="col-md-6">
                          <div className="highlight-item d-flex align-items-start gap-3">
                            ...
                            <div>
                              <strong>Social Empowerment</strong>
                              <p className="small text-muted mb-0">
                                Dedicated to empowering women and children
                    ...
                    <p className="mb-3">
                      Seema is a public health professional with more than 25
                      years of experience working with women, children and
                      adolescents bringing about social transformation in their
                      lives and leveraging government programmes. She has an
                      exceptional ability to congregate people from different
                      walks of life. Her alternative career could have been a
                      curator-foodie-travel guide!
                    </p>
                  </div>
                </div>
              </div>
