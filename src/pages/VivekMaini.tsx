...
export default function VivekMaini() {
  useEffect(() => {
      ...
      >
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="section-title mt-3">Vivek Maini</h2>
            <p className="section-desc mx-auto" style={{ maxWidth: 720 }}>
              Executive, Netram Eye Foundation
            </p>
          </div>
          <div
            ...
            <div className="col-lg-4">
              <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
                ...
                <div className="team-info pt-4 text-center">
                  <h5 className="mb-1">Vivek Maini</h5>
                  <span>Executive</span>
                </div>
              </div>
            </div>
            <div className="col-lg-8">
              <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
                <div className="mb-4">
                  ...
                  <p className="mb-4">
                    Vivek Maini serves as an Executive Member of Netram Eye
                    Foundation. He plays a crucial role in advising the board on
                    strategic growth and ensuring that the foundation's
                    resources are effectively utilized to reach the maximum
                    number of beneficiaries.
                  </p>
                  {/* Key Highlights */}
                  <div className="profile-highlights mt-4">
                    <h5 className="highlight-title mb-3">
                      <i className="bi bi-award-fill me-2" /> Mission Advisory
                      &amp; Engagement
                    </h5>
                        ...
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Strengthening ties between the foundation and the
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Overseeing the ground-level implementation of eye
                              screening camps and clinics.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Providing expert guidance on scaling operations
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Ensuring every foundation activity stays true to
                              the 'Sight for All' core value.
                            </p>
                          </div>
                        </div>
                      </div>
