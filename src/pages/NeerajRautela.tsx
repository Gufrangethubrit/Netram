...
export default function NeerajRautela() {
  useEffect(() => {
  ...
  return (
    <div>
      <Header />
      <Breadcrum title="Neeraj Rautela" />
      ...
      >
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="section-title mt-3">Neeraj Rautela</h2>
            <p className="section-desc mx-auto" style={{ maxWidth: 720 }}>
              State Program Coordinator, Netram Eye Foundation
            </p>
          </div>
          <div
            ...
            <div className="col-lg-4">
              <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
                <div className="team-img-wrap profile-photo-wrap">
                  <img
                    src="./assets/Management-Team/Neeraj-Rautela.png"
                    alt="Neeraj Rautela"
                  />
                ...
                <div className="team-info pt-4 text-center">
                  <h5 className="mb-1">Neeraj Rautela</h5>
                  <span>State Program Coordinator</span>
                </div>
              </div>
            </div>
            <div className="col-lg-8">
              <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
                <div className="mb-4">
                  ...
                  <p className="mb-4">
                    Neeraj Rautela actively supports the planning and execution
                    of awareness campaigns and outreach activities. His focus is
                    on delivering quality healthcare services to underserved and
                    marginalized communities.
                  </p>
                  {/* Key Highlights */}
                  <div className="profile-highlights mt-4">
                    <h5 className="highlight-title mb-3">
                      <i className="bi bi-award-fill me-2" /> State Operations
                      &amp; Awareness Strategy
                    </h5>
                    <div className="row g-3">
                        ...
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Designing high-impact visual and verbal messaging
                              for health literacy.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Outreach Coordination</strong>
                            <p className="small text-muted mb-0">
                              Managing mobile health units and logistics for
                              on-field screening drives.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Bridging the gap between specialized medical care
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Ensuring successful delivery of vision screening
                              and surgical support programs.
                            </p>
                          </div>
                        </div>
                      </div>
