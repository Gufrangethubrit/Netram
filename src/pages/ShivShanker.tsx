...
export default function ShivShanker() {
  useEffect(() => {
      ...
      >
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="section-title mt-3">Shiv Shanker</h2>
            <p className="section-desc mx-auto" style={{ maxWidth: 720 }}>
              U.P. Program Manager, Netram Eye Foundation
            </p>
          </div>
          <div
            ...
            <div className="col-lg-4">
              <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
                <div className="team-img-wrap profile-photo-wrap">
                  <img
                    src="./assets/Management-Team/Shiv-Shanker.png"
                    alt="Shiv Shanker"
                  />
                ...
                <div className="team-info pt-4 text-center">
                  <h5 className="mb-1">Shiv Shanker</h5>
                  <span>U.P. Program Manager</span>
                </div>
              </div>
            </div>
            <div className="col-lg-8">
              <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
                <div className="mb-4">
                  ...
                  <p className="mb-4">
                    Shiv Shanker oversees program implementation and operational
                    management across Uttar Pradesh. His leadership is critical
                    in executing large-scale healthcare outreach and community
                    welfare initiatives with regional precision.
                  </p>
                  {/* Key Highlights */}
                  <div className="profile-highlights mt-4">
                    <h5 className="highlight-title mb-3">
                      <i className="bi bi-award-fill me-2" /> Regional
                    ...
                    <div className="row g-3">
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Regional Management</strong>
                            <p className="small text-muted mb-0">
                              Directing state-wide operations across Uttar
                              Pradesh for maximum healthcare reach.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Healthcare Outreach</strong>
                            <p className="small text-muted mb-0">
                              Coordinating surgical camps and primary eye-care
                              clinics in high-need zones.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Program Fidelity</strong>
                            <p className="small text-muted mb-0">
                              Ensuring all field activities strictly adhere to
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Community Logistics</strong>
                            <p className="small text-muted mb-0">
                              Managing the complex chain of supplies and
                              personnel for remote field missions.
                            </p>
                          </div>
                        </div>
                      </div>
