...
export default function AnchalGuptaProfile() {
  useEffect(() => {
      ...
      >
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="section-title mt-3">Dr. Anchal Gupta</h2>
            <p className="section-desc mx-auto" style={{ maxWidth: 720 }}>
              Founder &amp; General Secretary, Netram Eye Foundation
            </p>
          </div>
          <div
            ...
            <div className="col-lg-4">
              <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
                ...
                <div className="team-info pt-4 text-center">
                  <h5 className="mb-1">Dr. Anchal Gupta</h5>
            ...
            <div className="col-lg-8">
              <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
                <div className="mb-4">
                  ...
                  <p className="mb-4">
                    Dr. Anchal Gupta leads Netram Eye Foundation with ethics,
                    empathy, and excellence, shaping it into a patient-first eye
                    care institution. With nearly 20 years of experience in
                    ophthalmology, she received advanced training from King
                    George's Medical University and Maulana Azad Medical
                    College.
                  </p>
                  {/* Key Highlights */}
                  <div className="profile-highlights mt-4">
                    <h5 className="highlight-title mb-3">
                      <i className="bi bi-award-fill me-2" /> Key Expertise
                      &amp; Impact
                    </h5>
                    <div className="row g-3">
                        ...
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Veteran Ophthalmologist with nearly two decades of
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Advanced Surgical Care</strong>
                            <p className="small text-muted mb-0">
                              Specialized in advanced ophthalmic surgeries and
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Committed to providing 'Sight for All' through
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Ethical Healthcare</strong>
                            <p className="small text-muted mb-0">
                              Advocate for ethical medical practices and
                              reaching the underserved sections of society.
                            </p>
                          </div>
                        </div>
                      </div>
