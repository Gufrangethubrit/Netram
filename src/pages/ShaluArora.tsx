...
export default function ShaluArora() {
  useEffect(() => {
      ...
      >
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="section-title mt-3">Shalu Arora</h2>
            <p className="section-desc mx-auto" style={{ maxWidth: 720 }}>
              CSR, Outreach &amp; Operations Lead, Netram Eye Foundation
            </p>
          </div>
          <div
            ...
            <div className="col-lg-4">
              <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
                <div className="team-img-wrap profile-photo-wrap">
                  <img
                    src="./assets/Management-Team/Shalu-Arora.png"
                    alt="Shalu Arora"
                  />
                ...
                <div className="team-info pt-4 text-center">
                  <h5 className="mb-1">Shalu Arora</h5>
                  <span>CSR, Outreach &amp; Operations Lead</span>
                </div>
              </div>
            </div>
            <div className="col-lg-8">
              <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
                <div className="mb-4">
                  ...
                  <p className="mb-4">
                    Shalu Arora is a dedicated social sector professional with a
                    Master’s degree in Social Work (MSW). As the lead for CSR
                    and Outreach at Netram Eye Foundation, she bridges the gap
                    between corporate social responsibility and community-level
                    impact.
                  </p>
                  {/* Key Highlights */}
                  <div className="profile-highlights mt-4">
                    <h5 className="highlight-title mb-3">
                      <i className="bi bi-award-fill me-2" /> Social Strategy
                    ...
                    <div className="row g-3">
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>CSR Strategy</strong>
                            <p className="small text-muted mb-0">
                              Designing and executing sustainable corporate
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Outreach Management</strong>
                            <p className="small text-muted mb-0">
                              Leading large-scale community awareness and health
                              screening campaigns.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Driving initiatives for child support and
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Strategic Collaboration</strong>
                            <p className="small text-muted mb-0">
                              Coordinating with Rotary International and other
                              NGOs for public welfare.
                            </p>
                          </div>
                        </div>
                      </div>
