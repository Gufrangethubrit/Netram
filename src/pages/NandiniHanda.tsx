...
export default function NandiniHanda() {
  useEffect(() => {
      ...
      >
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="section-title mt-3">Nandini Handa</h2>
            <p className="section-desc mx-auto" style={{ maxWidth: 720 }}>
              Corporate Communication Manager, Netram Eye Foundation
            </p>
          </div>
          <div
            ...
            <div className="col-lg-4">
              <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
                <div className="team-img-wrap profile-photo-wrap">
                  <img
                    src="./assets/Management-Team/Nandini-Handa.png"
                    alt="Nandini Handa"
                  />
                ...
                <div className="team-info pt-4 text-center">
                  <h5 className="mb-1">Nandini Handa</h5>
                  <span>Corporate Communication Manager</span>
                </div>
              </div>
            </div>
            <div className="col-lg-8">
              <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
                <div className="mb-4">
                  ...
                  <p className="mb-4">
                    Nandini Handa manages corporate communications and public
                    relations initiatives. She specializes in strengthening
                    organizational visibility and fostering deeper engagement
                    with stakeholders, collaborators, and the media.
                  </p>
                  {/* Key Highlights */}
                  <div className="profile-highlights mt-4">
                    <h5 className="highlight-title mb-3">
                      <i className="bi bi-award-fill me-2" /> Corporate
                    ...
                    <div className="row g-3">
                        ...
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Building and maintaining the foundation's
                              reputation through proactive media outreach.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Overseeing press releases, media interviews, and
                              coverage for major foundation events.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Cultivating long-term alliances with corporate
                              entities for CSR-driven impact.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Strategic Branding</strong>
                            <p className="small text-muted mb-0">
                              Developing integrated communication strategies to
                              align with global eye-care missions.
                            </p>
                          </div>
                        </div>
                      </div>
