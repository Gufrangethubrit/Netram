...
export default function AbhishekMishraProfile() {
  useEffect(() => {
  ...
  return (
    <div>
      <Header />
      <Breadcrum title="Abhishek Mishra" />
      ...
      >
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="section-title mt-3">Abhishek Mishra</h2>
            ...
            <div className="col-lg-4">
              <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
                ...
                <div className="team-info pt-4 text-center">
                  <h5 className="mb-1">Abhishek Mishra</h5>
            ...
            <div className="col-lg-8">
              <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
                <div className="mb-4">
                  ...
                  <p className="mb-4">
                    Abhishek Mishra serves as an Executive Member of Netram Eye
                    Foundation. He is a dedicated social advocate who focuses on
                    community-driven development and ensures that the
                    foundation's outreach programs are inclusive and impactful.
                  </p>
                  {/* Key Highlights */}
                  <div className="profile-highlights mt-4">
                    <h5 className="highlight-title mb-3">
                      <i className="bi bi-award-fill me-2" /> Social Leadership
                      &amp; Welfare
                    </h5>
                    <div className="row g-3">
                        ...
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Driving initiatives that provide sustainable
                              health resources to rural areas.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Humanitarian Leadership</strong>
                            <p className="small text-muted mb-0">
                              Championing the rights of the visually impaired
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Working with local NGOs to create a wider network
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Contributing to the long-term strategic vision of
