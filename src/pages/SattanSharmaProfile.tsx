...
export default function SattanSharmaProfile() {
  useEffect(() => {
        ...
        >
          <div className="container">
            <div className="text-center mb-5" data-aos="fade-up">
              ...
              <h2 className="section-title mt-3">Sattan Sharma</h2>
              <p className="section-desc mx-auto" style={{ maxWidth: 720 }}>
                Treasurer, Netram Eye Foundation
              </p>
            </div>
            <div
              ...
              <div className="col-lg-4">
                <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
                  ...
                  <div className="team-info pt-4 text-center">
                    <h5 className="mb-1">Sattan Sharma</h5>
                    <span>Treasurer</span>
                  </div>
                </div>
              </div>
              <div className="col-lg-8">
                <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
                  <div className="mb-4">
                    ...
                    <p className="mb-4">
                      Sattan Sharma serves as the Treasurer of Netram Eye
                      Foundation. He is a dynamic healthcare administrator and
                      social impact leader, recognized for transforming
                      community healthcare through impactful social innovation
                      and financial integrity.
                    </p>
                    {/* Key Highlights */}
                    <div className="profile-highlights mt-4">
                      <h5 className="highlight-title mb-3">
                        <i className="bi bi-award-fill me-2" /> Financial
                      ...
                      <div className="row g-3">
                          ...
                          <div className="highlight-item d-flex align-items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="small text-muted mb-0">
                                Ensuring efficient allocation of funds to
                                maximize patient care and outreach impact.
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="col-md-6">
                          <div className="highlight-item d-flex align-items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="small text-muted mb-0">
                                Maintaining strict adherence to NGO financial
                                regulations and audit standards.
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="col-md-6">
                          <div className="highlight-item d-flex align-items-start gap-3">
                            ...
                            <div>
                              <strong>Transparency &amp; Ethics</strong>
                              <p className="small text-muted mb-0">
                                Committed to ethical financial reporting and
                                clear accountability for all donations.
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="col-md-6">
                          <div className="highlight-item d-flex align-items-start gap-3">
                            ...
                            <div>
                              <strong>CSR Mobilization</strong>
                              <p className="small text-muted mb-0">
                                Building strong financial partnerships with
                                corporate donors for sustainable programs.
                              </p>
                            </div>
                          </div>
                        </div>
