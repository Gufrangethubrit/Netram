...
export default function WaseemAhmed() {
  return (
    <div>
      <Header />
      <Breadcrum title="Waseem Ahmed" />
      ...
      <div className="container">
        <div className="text-center mb-5" data-aos="fade-up">
          ...
          <h2 className="section-title mt-3">Waseem Ahmed</h2>
          <p className="section-desc mx-auto" style={{ maxWidth: 720 }}>
            IOCL Project Coordinator, Netram Eye Foundation
          </p>
        </div>
        <div
          ...
          <div className="col-lg-4">
            <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
              <div className="team-img-wrap profile-photo-wrap">
                <img
                  src="./assets/Management-Team/Waseem-Ahmed.png"
                  alt="Waseem Ahmed"
                />
              ...
              <div className="team-info pt-4 text-center">
                <h5 className="mb-1">Waseem Ahmed</h5>
                <span>IOCL Project Coordinator</span>
              </div>
            </div>
          </div>
          <div className="col-lg-8">
            <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
              <div className="mb-4">
                ...
                <p className="mb-4">
                  Waseem Ahmed coordinates IOCL collaborative projects and
                  community programs. His meticulous approach ensures the
                  successful execution of high-impact healthcare initiatives and
                  seamless multi-stakeholder coordination.
                </p>
                {/* Key Highlights */}
                <div className="profile-highlights mt-4">
                  <h5 className="highlight-title mb-3">
                    <i className="bi bi-award-fill me-2" /> Corporate Project
                    Coordination &amp; Social Impact
                  </h5>
                  <div className="row g-3">
                    <div className="col-md-6">
                      <div className="highlight-item d-flex align-items-start gap-3">
                        ...
                        <div>
                          <strong>IOCL Collaboration</strong>
                          <p className="small text-muted mb-0">
                            Managing high-level corporate partnerships to drive
                    ...
                    <div className="col-md-6">
                      <div className="highlight-item d-flex align-items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="small text-muted mb-0">
                            Overseeing complex project lifecycles from initial
                            planning to field execution.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="highlight-item d-flex align-items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="small text-muted mb-0">
                            Bridging communication between corporate sponsors
                    ...
                    <div className="col-md-6">
                      <div className="highlight-item d-flex align-items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="small text-muted mb-0">
                            Optimizing resource allocation for data-driven
                            results in public health drives.
                          </p>
                        </div>
                      </div>
                    </div>
