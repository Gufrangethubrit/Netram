...
export default function BSRawat() {
  useEffect(() => {
      ...
      >
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="section-title mt-3">B.S. Rawat</h2>
            <p className="section-desc mx-auto" style={{ maxWidth: 720 }}>
              Outreach Program Head, Netram Eye Foundation
            </p>
          </div>
          <div
            ...
            <div className="col-lg-4">
              <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
                <div className="team-img-wrap profile-photo-wrap">
                  <img
                    src="./assets/Management-Team/B.S.Rawat.png"
                    alt="B.S. Rawat"
                  />
                ...
                <div className="team-info pt-4 text-center">
                  <h5 className="mb-1">B.S. Rawat</h5>
                  <span>Outreach Program Head</span>
                </div>
              </div>
            </div>
            <div className="col-lg-8">
              <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
                <div className="mb-4">
                  ...
                  <p className="mb-4">
                    B.S. Rawat plays a key role in planning and executing
                    outreach initiatives and community eye care programs. His
                    extensive experience in field coordination ensures that our
                    missions reach those in most need.
                  </p>
                  {/* Key Highlights */}
                  <div className="profile-highlights mt-4">
                    <h5 className="highlight-title mb-3">
                      <i className="bi bi-award-fill me-2" /> Outreach Strategy
                      &amp; Field Leadership
                    </h5>
                    <div className="row g-3">
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Outreach Planning</strong>
                            <p className="small text-muted mb-0">
                              Architecting large-scale screening drives across
                              diverse and remote landscapes.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Community Eye Care</strong>
                            <p className="small text-muted mb-0">
                              Implementing comprehensive vision health programs
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Breaking barriers to ensure quality eye-care
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Field Coordination</strong>
                            <p className="small text-muted mb-0">
                              Managing logistical complexities and volunteer
                              teams during on-site missions.
                            </p>
                          </div>
                        </div>
                      </div>
