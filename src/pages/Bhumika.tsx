...
export default function Bhumika() {
  useEffect(() => {
      ...
      >
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="section-title mt-3">Bhumika</h2>
            <p className="section-desc mx-auto" style={{ maxWidth: 720 }}>
              Digital Management, Netram Eye Foundation
            </p>
          </div>
          <div
            ...
            <div className="col-lg-4">
              <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
                <div className="team-img-wrap profile-photo-wrap">
                  <img
                    src="./assets/Management-Team/Bhumika.png"
                    alt="Bhumika"
                  />
            ...
            <div className="col-lg-8">
              <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
                <div className="mb-4">
                  ...
                  <p className="mb-4">
                    Bhumika manages digital communication and online outreach
                    for Netram Eye Foundation. She plays a vital role in
                    strengthening the organization’s digital footprint and
                    ensuring our mission and values resonate across virtual
                    platforms.
                  </p>
                  {/* Key Highlights */}
                  <div className="profile-highlights mt-4">
                    <h5 className="highlight-title mb-3">
                      <i className="bi bi-award-fill me-2" /> Digital
                      Transformation &amp; Media Strategy
                    </h5>
                    <div className="row g-3">
                        ...
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Crafting compelling narratives to engage global
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Content Coordination</strong>
                            <p className="small text-muted mb-0">
                              Developing and managing a diverse editorial
                              calendar for consistent brand voice.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Online Outreach</strong>
                            <p className="small text-muted mb-0">
                              Leveraging social media and web tools to expand
                              the foundation's supporter network.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Awareness Initiatives</strong>
                            <p className="small text-muted mb-0">
                              Launching data-driven digital campaigns to promote
                              preventable eye care solutions.
                            </p>
                          </div>
                        </div>
                      </div>
