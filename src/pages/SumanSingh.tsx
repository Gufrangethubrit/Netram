...
export default function SumanSingh() {
  useEffect(() => {
      ...
      >
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="section-title mt-3">Suman Singh</h2>
            ...
            <div className="col-lg-4">
              <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
                <div className="team-img-wrap profile-photo-wrap">
                  <img
                    src="./assets/Management-Team/Suman-Singh.png"
                    alt="Suman Singh"
                  />
                ...
                <div className="team-info pt-4 text-center">
                  <h5 className="mb-1">Suman Singh</h5>
            ...
            <div className="col-lg-8">
              <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
                <div className="mb-4">
                  ...
                  <p className="mb-4">
                    Suman Singh manages and coordinates state-level healthcare
                    and outreach programs. Her leadership ensures the smooth
                    implementation of our health initiatives across diverse
                    regional landscapes.
                  </p>
                  {/* Key Highlights */}
                  <div className="profile-highlights mt-4">
                    <h5 className="highlight-title mb-3">
                      <i className="bi bi-award-fill me-2" /> State Coordination
                        ...
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Synchronizing district-level activities for
                              unified state-wide impact.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Spearheading specialized clinics and screening
                              camps in remote clusters.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Ensuring operational efficiency and compliance in
                              long-term health projects.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Building local networks to foster trust and
