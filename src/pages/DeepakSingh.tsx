...
export default function DeepakSingh() {
  useEffect(() => {
      ...
      >
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="section-title mt-3">Deepak Singh</h2>
            <p className="section-desc mx-auto" style={{ maxWidth: 720 }}>
              Executive Member, Netram Eye Foundation
            </p>
          </div>
          <div
            ...
            <div className="col-lg-4">
              <div className="team-card h-100 p-3 p-lg-4 profile-photo-card">
                ...
                <div className="team-info pt-4 text-center">
                  <h5 className="mb-1">Deepak Singh</h5>
            ...
            <div className="col-lg-8">
              <div className="team-card h-100 p-4 p-lg-5 text-start profile-bio-card">
                <div className="mb-4">
                  ...
                  <p className="mb-4">
                    Deepak Singh is a renowned social leader and the Cultural
                    Ambassador of Seychelles. As an Executive Member of Netram
                    Eye Foundation, he brings a global perspective to our
                    mission, fostering international partnerships and
                    humanitarian initiatives.
                  </p>
                  {/* Key Highlights */}
                  <div className="profile-highlights mt-4">
                    <h5 className="highlight-title mb-3">
                      <i className="bi bi-award-fill me-2" /> Global Diplomacy
                      &amp; Humanitarian Impact
                    </h5>
                    <div className="row g-3">
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Cultural Diplomacy</strong>
                            <p className="small text-muted mb-0">
                              Promoting global harmony and people-to-people
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Humanitarian Work</strong>
                            <p className="small text-muted mb-0">
                              Leading international social development projects
                      ...
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-0">
                              Building bridges with international organizations
                              to scale the foundation's reach.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="highlight-item d-flex align-items-start gap-3">
                          ...
                          <div>
                            <strong>Heritage Promotion</strong>
                            <p className="small text-muted mb-0">
                              Advocating for the preservation of cultural
